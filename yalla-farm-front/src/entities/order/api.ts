...
export function normalizeOrder(raw: RawOrder): ApiOrder {
  ...
  return {
    ...
    paymentReceiverAccount: raw.paymentReceiverAccount != null ? String(raw.paymentReceiverAccount) : null,
    paymentComment: raw.paymentComment != null ? String(raw.paymentComment) : null,
    ...
    clientTelegramId: raw.clientTelegramId != null ? Number(raw.clientTelegramId) : null,
