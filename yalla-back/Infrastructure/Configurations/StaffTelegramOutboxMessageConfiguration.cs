...
public sealed class StaffTelegramOutboxMessageConfiguration : IEntityTypeConfiguration<StaffTelegramOutboxMessage>
{
  public void Configure(EntityTypeBuilder<StaffTelegramOutboxMessage> builder)
  {
    builder.ToTable("staff_telegram_outbox_messages");
    ...
    builder.HasIndex(x => x.CreatedAtUtc)
      .HasDatabaseName("ix_staff_tg_outbox_created_at_utc");
  }
}
