...
public sealed class SuperAdminTelegramOutboxMessageConfiguration : IEntityTypeConfiguration<SuperAdminTelegramOutboxMessage>
{
  public void Configure(EntityTypeBuilder<SuperAdminTelegramOutboxMessage> builder)
  {
    builder.ToTable("superadmin_telegram_outbox_messages");
    ...
    builder.HasIndex(x => new { x.MessageKey, x.SuperAdminId, x.ChatId })
      .IsUnique()
      .HasDatabaseName("ux_superadmin_tg_outbox_msgkey_admin_chat");

    builder.HasIndex(x => new { x.State, x.NextAttemptAtUtc })
      .HasDatabaseName("ix_superadmin_tg_outbox_state_next_attempt_at_utc");

    builder.HasIndex(x => x.CreatedAtUtc)
      .HasDatabaseName("ix_superadmin_tg_outbox_created_at_utc");
  }
}
