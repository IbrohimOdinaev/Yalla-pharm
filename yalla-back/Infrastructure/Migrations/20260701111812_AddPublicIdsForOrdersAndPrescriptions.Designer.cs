...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260701111812_AddPublicIdsForOrdersAndPrescriptions")]
    partial class AddPublicIdsForOrdersAndPrescriptions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Yalla.Domain.Entities.ExternalProductLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("SourceId", "ExternalProductId")
                        .IsUnique()
                        .HasDatabaseName("ux_external_product_links_source_id_external_product_id");

                    b.HasIndex("PharmacyId", "SourceType", "ExternalProductId")
                        .HasDatabaseName("ix_external_product_links_pharmacy_source_external_id");

                    b.ToTable("external_product_links", (string)null);
                });

            modelBuilder.Entity("Yalla.Domain.Entities.HomePopularMedicine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("home_popular_medicines", (string)null);
                });

            modelBuilder.Entity("Yalla.Domain.Entities.IntegrationSource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Yalla.Domain.Entities.MedicineBarcode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("MedicineId", "Barcode")
                        .IsUnique()
                        .HasDatabaseName("ux_medicine_barcodes_medicine_id_barcode");

                    b.ToTable("medicine_barcodes", (string)null);
                });
            ...
            modelBuilder.Entity("Yalla.Domain.Entities.OneCImportRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Yalla.Domain.Entities.PaymentSettings", b =>
                {
                    ...
                    b.Property<decimal>("PharmacyOrderReadyFeeAmount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric(18,2)")
                        .HasDefaultValue(0m)
                        .HasColumnName("pharmacy_order_ready_fee_amount");

                    b.Property<decimal>("PrescriptionDecodedFeeAmount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric(18,2)")
                        .HasDefaultValue(0m)
            ...
            modelBuilder.Entity("Yalla.Domain.Entities.PharmacyWithdrawalRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<Guid?>("CompletedBySuperAdminId")
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ReceiptImageKey")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)")
                    ...
                    b.HasIndex("CompletedBySuperAdminId");
                    ...
                    b.ToTable("pharmacy_withdrawal_requests", (string)null);
                });
            ...
            modelBuilder.Entity("Yalla.Domain.Entities.StaffCompensationEarning", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("StaffUserId", "CreatedAtUtc");

                    b.ToTable("staff_compensation_earnings", (string)null);
                });

            modelBuilder.Entity("Yalla.Domain.Entities.StaffCompensationPayout", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<Guid>("PaidBySuperAdminId")
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("PaidBySuperAdminId");

                    b.HasIndex("StaffUserId", "PaidAtUtc");

                    b.ToTable("staff_compensation_payouts", (string)null);
                });

            modelBuilder.Entity("Yalla.Domain.Entities.StaffCompensationPayoutRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("staff_compensation_payout_requests", (string)null);
                });

            modelBuilder.Entity("Yalla.Domain.Entities.StaffTelegramOutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("PharmacyWorkerId")
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("MessageKey", "PharmacyWorkerId", "ChatId")
                        .IsUnique()
                        .HasDatabaseName("ux_staff_tg_outbox_msgkey_worker_chat");

                    b.ToTable("staff_telegram_outbox_messages", (string)null);
                });

            modelBuilder.Entity("Yalla.Domain.Entities.StaffTelegramRecipient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("PharmacyWorkerId", "ChatId")
                        .IsUnique()
                        .HasDatabaseName("ux_staff_tg_recipients_worker_chat");

                    b.HasIndex("PharmacyWorkerId", "IsActive")
                        .HasDatabaseName("ix_staff_tg_recipients_worker_active");

                    b.ToTable("staff_telegram_recipients", (string)null);
                });

            modelBuilder.Entity("Yalla.Domain.Entities.SuperAdminTelegramOutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("MessageKey", "SuperAdminId", "ChatId")
                        .IsUnique()
                        .HasDatabaseName("ux_superadmin_tg_outbox_msgkey_admin_chat");

                    b.ToTable("superadmin_telegram_outbox_messages", (string)null);
                });

            modelBuilder.Entity("Yalla.Domain.Entities.SuperAdminTelegramRecipient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("SuperAdminId", "ChatId")
                        .IsUnique()
                        .HasDatabaseName("ux_superadmin_tg_recipients_admin_chat");

                    b.HasIndex("SuperAdminId", "IsActive")
                        .HasDatabaseName("ix_superadmin_tg_recipients_admin_active");

                    b.ToTable("superadmin_telegram_recipients", (string)null);
                });
            ...
            modelBuilder.Entity("Yalla.Domain.Entities.TelegramAuthSession", b =>
                {
                    ...
                    b.Property<long?>("ConfirmationChatId")
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("telegram_auth_sessions", (string)null);
                });

            modelBuilder.Entity("Yalla.Domain.Entities.TelegramOutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int?>("PrescriptionStatusSnapshot")
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Yalla.Domain.Entities.ExternalProductLink", b =>
                {
                    ...
                    b.HasOne("Yalla.Domain.Entities.IntegrationSource", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Yalla.Domain.Entities.PharmacyWithdrawalRequest", b =>
                {
                    b.HasOne("Yalla.Domain.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("CompletedBySuperAdminId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Yalla.Domain.Entities.StaffCompensationPayout", b =>
                {
                    b.HasOne("Yalla.Domain.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("PaidBySuperAdminId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Yalla.Domain.Entities.StaffCompensationPayoutRequest", b =>
                {
                    ...
                    b.HasOne("Yalla.Domain.Entities.StaffCompensationPayout", null)
                        .WithMany()
