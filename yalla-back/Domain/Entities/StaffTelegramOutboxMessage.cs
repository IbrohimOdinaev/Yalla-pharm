...
public sealed class StaffTelegramOutboxMessage
{
  ...
  private StaffTelegramOutboxMessage() { }

  public static StaffTelegramOutboxMessage CreateForOrder(
    Guid orderId,
    Guid pharmacyId,
    ...
    DateTime nowUtc)
  {
    ...
    return Create(
      orderId: orderId,
      manualLookupRequestId: null,
      pharmacyId: pharmacyId,
      pharmacyWorkerId: pharmacyWorkerId,
      chatId: chatId,
      messageKey: $"order:{orderId:D}:under_review",
      message: message,
      nowUtc: nowUtc);
  }

  public static StaffTelegramOutboxMessage CreateForManualLookup(
    ...
    DateTime nowUtc)
  {
    ...
    return Create(
      ...
      pharmacyWorkerId: pharmacyWorkerId,
      chatId: chatId,
      messageKey: $"lookup:{manualLookupRequestId:D}:open",
      message: message,
      nowUtc: nowUtc);
  }
  ...
  private static StaffTelegramOutboxMessage Create(
    Guid? orderId,
    Guid? manualLookupRequestId,
    Guid? pharmacyId,
    Guid pharmacyWorkerId,
    ...
    DateTime nowUtc)
  {
    ...
    return new StaffTelegramOutboxMessage
    {
      Id = Guid.NewGuid(),
      OrderId = orderId,
      ManualLookupRequestId = manualLookupRequestId,
